...
//    textEdit->setColor(QColor("b2def0"));
    ...
    textLexer->setColor(QColor("#46e131"),QsciLexerCPP::Comment);
    textLexer->setColor(QColor("#85db79"),QsciLexerCPP::CommentLine);
    textLexer->setColor(QColor("#90be8a"),QsciLexerCPP::CommentLineDoc);
    textLexer->setColor(QColor("#e5d41b"),QsciLexerCPP::Number);
    textLexer->setColor(QColor("#932ceb"),QsciLexerCPP::Keyword);
    textLexer->setColor(QColor("#29d7e7"),QsciLexerCPP::DoubleQuotedString);
    textLexer->setColor(QColor("#56b1b9"),QsciLexerCPP::SingleQuotedString);
    textLexer->setColor(QColor("#20aabb"),QsciLexerCPP::PreProcessor);
    textLexer->setColor(QColor("#e1a53e"),QsciLexerCPP::Operator);
    textLexer->setColor(QColor("#fcad25"),QsciLexerCPP::Identifier);
    ...
    apis->add(QString("volatile"));apis->add(QString("wchar_t"));apis->add(QString("while"));
...
//        qDebug()<<"读取失败";
    ...
    textEdit->setCaretLineBackgroundColor(QColor("#bfd7e4"));   // 当前行显示背景色
    // 设置选中区域颜色
